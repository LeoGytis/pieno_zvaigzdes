...
const ProductSlide5 = ({ onClose }: ProductSlideProps) => {
  return (
    <ProductSlideContainer onClose={onClose} productImage={productImage}>
      <h1 className="product_title">Svalya Pizza Mozzarella 40 %</h1>
      ...
      <div className="text-grey mb-14">
        ...
        <p>
          Cheese product with vegetable fat PIZZA MOZZARELLA, 40% fat in dry
          matter.
        </p>
        <p>
        ...
        <p className="text-grey mb-6">
          ...
          saturates 10,0 g; carbohydrate 0,5 g, of which sugars 0,5; protein
          24,5 g, salt 1,0 g.
        </p>
      </div>
      <div className="text-grey mb-14">
      ...
      <div className="flex gap-10 mb-14">
        <Image
          src="/images/mozzarella_pizza/logistic_box.png"
          alt="logistic_box"
          width={204}
          height={101}
        />
      ...
      <div className="flex gap-10 mb-14">
        <Image
          src="/images/mozzarella_pizza/palette_size.png"
          alt="palette_size"
          width={149}
          height={120}
        />

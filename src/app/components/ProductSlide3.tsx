      ...
      <div className="xl:w-1/2 text-sm text-blue pl-16 pr-28 py-5 xl:py-16">
        ...
        <div>
          ...
          <p className="text-grey mb-6">
            ...
            kJ/299 kcal; fat 21,5 g, of which: saturates 14,0 g; carbohydrate
            1,8 g, of which: sugars 0,5 g, starch 1,3 g; food fibre 0 g, protein
            24,5 g, salt 0,8 g. * Possibility of production with no anti-caking
            agent.
          </p>
